...
function Sports() {
    ...
    const fetchData = async () => {
        let resonse = await fetch("https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=524661fbfd13483594486c2756ae530b")
    ...
    return (
        <div>
            <div className="row">
                <h1 className='d-flex justify-content-center'>Sports News</h1>
                <Link to={'/'}>Back</Link>
                {
                    Sports && Sports.map((data) => {
                        return (
                            <div className="col-3">
